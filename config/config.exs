...
config :medium_graphql_api, MediumGraphqlApiWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "uVuEmM0GCt/G37eslWfhzbsdmY8f034CMSWLpzfKaR9RO4G4gOIhpnTadWBg3ef+",
  ...
  live_view: [signing_salt: "hb1k3BaV"]
...
config :medium_graphql_api, MediumGraphqlApi.Guardian,
       ...
       secret_key: "4SsiLbSlOcEtvhWF3FQ6FzbMunfmOcouGlFD3+vVLc+6E2mb0l5i9secEfET57r0"
